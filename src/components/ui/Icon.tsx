...
export const Icon = ({ name, size = 16, color = 'currentColor' }: IconProps) => {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    starF: <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill={color} stroke={color}/>,
    ...
    bot: <><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="9" cy="16" r="1"/><circle cx="15" cy="16" r="1"/><path d="M12 2v4"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/></>,
    ...
    calculator: <><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="14" x2="8" y2="14.01"/><line x1="12" y1="14" x2="12" y2="14.01"/><line x1="8" y1="18" x2="16" y2="18"/></>,
...
export const Flag = ({ country, size = 16 }: FlagProps) => {
  if (country === 'tr') {
    return (
      <svg width={size} height={size} viewBox="0 0 32 24" style={{ borderRadius: 2 }}>
        <rect width="32" height="24" fill="#E30A17" />
        <circle cx="13" cy="12" r="6" fill="#fff" />
        <circle cx="14.5" cy="12" r="4.8" fill="#E30A17" />
        <polygon points="16,12 19.5,9.5 17,12.8 19.5,14.5 16,12" fill="#fff" transform="rotate(18,17,12)" />
      </svg>
    );
  }
  return (
