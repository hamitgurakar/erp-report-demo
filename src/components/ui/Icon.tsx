...
export const Icon = ({ name, size = 16, color = 'currentColor' }: IconProps) => {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    gripV: <><circle cx="9" cy="5" r="1" fill={color}/><circle cx="15" cy="5" r="1" fill={color}/><circle cx="9" cy="12" r="1" fill={color}/><circle cx="15" cy="12" r="1" fill={color}/><circle cx="9" cy="19" r="1" fill={color}/><circle cx="15" cy="19" r="1" fill={color}/></>,
