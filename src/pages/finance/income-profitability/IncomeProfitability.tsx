...
import {
  ...
  MiniChartPopover, ChangePct, StatusBadge, Dropdown, type FinAlert,
...
// ── SVG Waterfall (P&L WaterfallChart görsel diliyle uyumlu) ──
interface WFStep { label: string; value: number; isTotal: boolean }
const Waterfall = ({ steps, t, fmt, pp }: { steps: WFStep[]; t: import('../../../types').Theme; fmt: (v: number) => string; pp?: boolean }) => {
  let running = 0;
  ...
  const barW = 44, gap = 14, TOP = 22, PLOT = 150, BOT = 210;
